...
public class PurchaseReturn implements Serializable {
	...
	private Set<PurchaseReturnDetail> purchaseReturnDetail;
	@ManyToOne
	...
	/**
	 * Access method for purchaseReturnDetail.
	 *
	 * @return the current value of purchaseReturnDetail
	 */
	public Set<PurchaseReturnDetail> getPurchaseReturnDetail() {
		return purchaseReturnDetail;
	}

	/**
	 * Setter method for purchaseReturnDetail.
	 *
	 * @param aPurchaseReturnDetail the new value for purchaseReturnDetail
	 */
	public void setPurchaseReturnDetail(Set<PurchaseReturnDetail> aPurchaseReturnDetail) {
		purchaseReturnDetail = aPurchaseReturnDetail;
	}
	...
	/**
	 * Compares the key for this instance with another PurchaseReturn.
	 *
	 * @param other The object to compare to
	 * @return True if other object is instance of class PurchaseReturn and the key
	 *         objects are equal
	 */
	private boolean equalKeys(Object other) {
		...
		if (!(other instanceof PurchaseReturn)) {
			return false;
		}
		PurchaseReturn that = (PurchaseReturn) other;
	...
	/**
	 * Compares this instance with another PurchaseReturn.
	 *
	 * @param other The object to compare to
	...
	public boolean equals(Object other) {
		if (!(other instanceof PurchaseReturn))
			return false;
		return this.equalKeys(other) && ((PurchaseReturn) other).equalKeys(this);
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("[PurchaseReturn |");
