...
CREATE TABLE `variant_values` (
  ...
  KEY `product_variant_prodcuct_id_idx` (`Product_id`),
  KEY `product_option_option_id_idx` (`Option_id`),
  ...
  CONSTRAINT `product_option_option_id` FOREIGN KEY (`Option_id`) REFERENCES `product_options` (`Option_id`),
  CONSTRAINT `product_option_product_id` FOREIGN KEY (`Product_id`) REFERENCES `product_options` (`Product_id`),
  CONSTRAINT `product_variant_variant_id` FOREIGN KEY (`Variant_id`) REFERENCES `product_variants` (`Variant_id`)
...
-- Dump completed on 2022-05-07 12:35:43
