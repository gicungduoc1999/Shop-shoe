...
CREATE TABLE `detail_bills` (
  `DetailBill_id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `product_variant_id_idx` (`Variant_id`),
  KEY `bill_index` (`Bill_id`),
  CONSTRAINT `bill_index` FOREIGN KEY (`Bill_id`) REFERENCES `bills` (`Bill_id`),
...
-- Dump completed on 2022-05-07 12:35:02
